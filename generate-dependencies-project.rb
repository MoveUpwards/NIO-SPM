...
project = Xcodeproj::Project.open('SwiftPackagesWithiOS.xcodeproj')

project.targets.each do |target|
  module_map_file = "SwiftPackagesWithiOS.xcodeproj/GeneratedModuleMap/#{target.name}/module.modulemap"
